...
HD_PWD='C:/Vivado_Pr/Practica_2/Practica_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sintesis_cerrojo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sintesis_cerrojo.tcl
