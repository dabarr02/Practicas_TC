...
HD_PWD='C:/Vivado_Pr/Practica_2/Practica_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sintesis_cerrojo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sintesis_cerrojo.tcl -notrace
