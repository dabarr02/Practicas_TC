...
HD_PWD='C:/Vivado_Pr/Practica_3/Practica_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log red_iterativa_comparadores.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source red_iterativa_comparadores.tcl
