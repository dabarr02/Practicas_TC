...
HD_PWD='C:/Vivado_Pr/Practica1_Avanzada/Practica1_Avanzada.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sintesis_contador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sintesis_contador.tcl
