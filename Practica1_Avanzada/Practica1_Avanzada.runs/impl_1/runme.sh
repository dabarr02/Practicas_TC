...
HD_PWD='C:/Vivado_Pr/Practica1_Avanzada/Practica1_Avanzada.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sintesis_contador.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sintesis_contador.tcl -notrace
