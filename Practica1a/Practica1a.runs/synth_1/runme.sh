...
HD_PWD='C:/Vivado_Pr/Practica1a/Practica1a.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumador.tcl
