...
HD_PWD='C:/Vivado_Pr/Practica_4_Avanzada/Practica_4_Avanzada.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sintesis_div.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sintesis_div.tcl
