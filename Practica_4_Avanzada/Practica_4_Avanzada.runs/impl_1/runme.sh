...
HD_PWD='C:/Vivado_Pr/Practica_4_Avanzada/Practica_4_Avanzada.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sintesis_div.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sintesis_div.tcl -notrace
