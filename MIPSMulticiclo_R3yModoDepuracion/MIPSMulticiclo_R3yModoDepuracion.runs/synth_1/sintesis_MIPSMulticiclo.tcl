...
synth_design -top sintesis_MIPSMulticiclo -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef sintesis_MIPSMulticiclo.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file sintesis_MIPSMulticiclo_utilization_synth.rpt -pb sintesis_MIPSMulticiclo_utilization_synth.pb"
